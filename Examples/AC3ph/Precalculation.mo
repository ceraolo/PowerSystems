...
package Precalculation "Precalculation of machine matrices"
  ...
  model Z_matrixTrDat0 "z-matrix from transient data, n=1, 0"
    ...
    parameter Boolean use_xtr=true "use t_closed and x_transient?" annotation (
        choices(choice=true "t_closed and x_tr", choice=false
          "t_closed and t_open"));
...
</html>"), Diagram(graphics={Line(points={{-40,80},{-40,10}}, color={0,0,255}),
            Line(points={{90,50},{90,40}}, color={0,0,255}),Line(points={{-100,
            10},{90,10},{90,20}}, color={0,0,255}),Line(points={{-40,-20},{-40,
            -90}}, color={0,0,255}),Text(
              extent={{-66,90},{-52,84}},
              lineColor={0,0,255},
              ...
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid,
              textString="xm_d = x_d - xsig_s"),Ellipse(extent={{64,16},{76,4}},
            lineColor={0,0,255}),Text(
              extent={{78,6},{92,0}},
              lineColor={0,0,255},
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid,
              textString="v_f"),Line(points={{-80,80},{90,80},{90,70}}, color={
            0,0,255}),Rectangle(
              extent={{-100,82},{-80,78}},
              lineColor={0,0,255},
              fillColor={255,255,255},
              ...
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid,
              textString="r_rd1"),Line(points={{-80,-20},{-40,-20}}, color={0,0,
            255}),Line(points={{-100,-90},{-40,-90}}, color={0,0,255}),Text(
              extent={{-66,-10},{-52,-16}},
              lineColor={0,0,255},
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid,
...
<p><a href=\"modelica://PowerSystems.Examples.AC3ph.Precalculation\">up users guide</a></p>
            ...
            Line(points={{90,50},{90,40}}, color={0,0,255}),Line(points={{-100,
            10},{90,10},{90,20}}, color={0,0,255}),Line(points={{-40,-20},{-40,
            -90}}, color={0,0,255}),Line(points={{-100,-90},{90,-90},{90,-80}},
            color={0,0,255}),Line(points={{-80,-20},{90,-20},{90,-30}}, color={
            0,0,255}),Line(points={{90,-50},{90,-60}}, color={0,0,255}),Text(
              extent={{-66,90},{-52,84}},
              lineColor={0,0,255},
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid,
...
<p><a href=\"modelica://PowerSystems.Examples.AC3ph.Precalculation\">up users guide</a></p>
            ...
            Line(points={{50,80},{50,10}}, color={0,0,255}),Line(points={{90,50},
            {90,40}}, color={0,0,255}),Line(points={{-100,10},{90,10},{90,20}},
            color={0,0,255}),Line(points={{50,-20},{50,-90}}, color={0,0,255}),
            Line(points={{-40,-20},{-40,-90}}, color={0,0,255}),Line(points={{-100,
            -90},{90,-90},{90,-80}}, color={0,0,255}),Line(points={{-80,-20},{
            90,-20},{90,-30}}, color={0,0,255}),Line(points={{90,-50},{90,-60}},
            color={0,0,255}),Text(
              extent={{24,90},{38,84}},
              lineColor={0,0,255},
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid,
              textString="xm_d2"),Text(
              extent={{-66,90},{-52,84}},
              lineColor={0,0,255},
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid,
  ...
  model Z_matrixTrDat3 "z-matrix from transient data, n=3"
    ...
    parameter Boolean use_xtr=true "use t_closed and x_transient?" annotation (
        choices(choice=true "t_closed and x_tr", choice=false
          "t_closed and t_open"));
    parameter SI.Time[:] tc_d={0.869154751730285,0.028837675377106,
        0.00293370131083294}
      "time constant closed-loop d-axis {tc_d', tc_d'', ..}"
      annotation (Dialog(enable=use_trans));
    parameter SI.Time[:] tc_q={0.710852334653427,0.0267828156988275,
        0.00180497772676905}
      "time constant closed-loop q-axis {tc_q', tc_q'', ..}"
      annotation (Dialog(enable=use_trans));
    parameter SI.Time[:] to_d={4.79391852025869,0.0390156982688014,
        0.00331427152151774}
      "time constant open-loop d-axis {to_d', to_d'', ..}"
      annotation (Dialog(enable=use_trans and (not use_xtr)));
    parameter SI.Time[:] to_q={4.63399482930977,0.0387883296526998,
        0.00197933074735668}
      "time constant open-loop q-axis {to_q', to_q'', ..}"
      annotation (Dialog(enable=use_trans and (not use_xtr)));
    parameter SIpu.Reactance[n_d] xtr_d={0.324237799805601,0.238193407852477,
        0.209956053815068} "trans reactance d-axis {xtr_d', xtr_d'', ..}"
      annotation (Dialog(enable=use_xtr));
    parameter SIpu.Reactance[n_q] xtr_q={0.275669319075036,0.187924853846143,
        0.170964423631031} "trans reactance q-axis {xtr_q', xtr_q'', ..}"
      annotation (Dialog(enable=use_xtr));
    parameter SIpu.Reactance x_d=1.77 "syn reactance d-axis";
    parameter SIpu.Reactance x_q=1.77 "syn reactance q-axis";
    parameter SIpu.Reactance xsig_s=0.17 "leakage reactance stator";
...
<p><a href=\"modelica://PowerSystems.Examples.AC3ph.Precalculation\">up users guide</a></p>
            ...
            Line(points={{10,80},{10,10}}, color={0,0,255}),Line(points={{50,80},
            {50,10}}, color={0,0,255}),Line(points={{90,50},{90,40}}, color={0,
            0,255}),Line(points={{-100,10},{90,10},{90,20}}, color={0,0,255}),
            Line(points={{50,-20},{50,-90}}, color={0,0,255}),Line(points={{10,
            -20},{10,-90}}, color={0,0,255}),Line(points={{-40,-20},{-40,-90}},
            color={0,0,255}),Line(points={{-100,-90},{90,-90},{90,-80}}, color=
            {0,0,255}),Line(points={{-80,-20},{90,-20},{90,-30}}, color={0,0,
            255}),Line(points={{90,-50},{90,-60}}, color={0,0,255}),Text(
              extent={{-14,66},{6,60}},
              lineColor={0,0,255},
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid,
  ...
  model Z_matrixEqCirc0 "z-matrix from equivalent circuit, n=1, 0"
    ...
    parameter SIpu.Reactance[size(xsig_rd, 1) - 1] xm_d=fill(0, 0)
      "coupling-reactance d-axis" annotation (Dialog(enable=not use_trans));
    parameter SIpu.Resistance[size(xsig_rd, 1)] r_rd={0.0011}
      "resistance rotor d-axis{f}" annotation (Dialog(enable=not use_trans));
    parameter SIpu.Resistance[size(xsig_rq, 1)] r_rq=fill(0, 0)
      "resistance rotor q-axis{Q}" annotation (Dialog(enable=not use_trans));
...
<p><a href=\"modelica://PowerSystems.Examples.AC3ph.Precalculation\">up users guide</a></p>
  ...
  model Z_matrixEqCirc2 "z-matrix from equivalent circuit, n=2"
    ...
    parameter SIpu.Resistance[size(xsig_rd, 1)] r_rd={0.0011,0.012}
      "resistance rotor d-axis{f, D}" annotation (Dialog(enable=not use_trans));
...
<p><a href=\"modelica://PowerSystems.Examples.AC3ph.Precalculation\">up users guide</a></p>
  ...
  model TransDatFromEqCirc "Calculates transient data from equivalent circuit"
    ...
    output SIpu.Reactance[n_d] xtr_d(each unit="1")
    ...
    output SIpu.Reactance[n_q] xtr_q(each unit="1")
