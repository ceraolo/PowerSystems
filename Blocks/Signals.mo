...
"));
  ...
  equation
    ...
    annotation (
      defaultComponentName="transSig1",
      Documentation(info="<html>
...
"),   Icon(coordinateSystem(
  ...
  equation
    y = 0.5*({a_end + a_start,ph_end + ph_start} + {a_end - a_start,ph_end -
      ph_start}*tanh(coef*(time - t_change)));
    annotation (
      defaultComponentName="transPh1",
      Documentation(info="<html>
...
"),   Icon(coordinateSystem(
  ...
  protected
    ...
    annotation (
      defaultComponentName="transFreq1",
      Documentation(info="<html>
...
"),   Icon(coordinateSystem(
  ...
  equation
    ...
    annotation (
      defaultComponentName="varSin_spec",
      Documentation(info="<html>
<p>The signal has variable amplitude and frequency and constant phase.
The relative angle of the phases can be chosen arbitrarily (for non-symmetric signals).</p>
</html>
