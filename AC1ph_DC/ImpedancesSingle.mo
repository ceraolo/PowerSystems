...
<p>Info see package AC1ph_DC.ImpedancesSingle.</p>
      ...
      Icon(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-100,-100},{100,100}},
          grid={2,2}), graphics={Line(points={{-90,0},{-16,0}}, color={0,0,255}),
            Line(points={{90,0},{16,0}}, color={0,0,255}),Rectangle(
              extent={{-10,50},{10,-50}},
      ...
      Diagram(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(
            ...
            -10},{-10,-10}}, color={0,0,255}),Line(points={{4,10},{60,10},{60,-10},
            {10,-10}}, color={0,0,255})}));
  end Capacitor;
...
<p>Info see package AC1ph_DC.ImpedancesSingle.</p>
      ...
      Icon(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-100,-100},{100,100}},
          grid={2,2}), graphics={Line(points={{-90,0},{-70,0}}, color={0,0,255}),
            Line(points={{90,0},{70,0}}, color={0,0,255}),Line(points={{-10,0},
            {10,0}}, color={0,0,255}),Line(points={{0,0},{0,-90}}, color={0,0,
            255}),Text(
