...
"),   Icon(coordinateSystem(
  ...
  equation
    ...
    C*der(v) + G*v = [[2*(term_p.i - i[:, 1])], i[:, 1:ne - 1] - i[:, 2:ne], [2
      *(i[:, ne] + term_n.i)]];
    L*der(i) + diagonal(R)*i = v[:, 1:ne] - v[:, 2:ne1];
    annotation (
      defaultComponentName="line1",
      Documentation(info="<html>
...
"),   Icon(coordinateSystem(
      ...
      Diagram(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(
              ...
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{-84,10},{-20,10}},
            color={0,0,255}),Line(points={{-84,-10},{-20,-10}}, color={0,0,255}),
            Line(points={{-60,10},{-60,3}}, color={0,0,255}),Line(points={{-60,
            -3},{-60,-10}}, color={0,0,255}),Line(points={{-46,10},{-46,6}},
            color={0,0,255}),Line(points={{-46,-6},{-46,-10}}, color={0,0,255}),
            Rectangle(
              extent={{-81,-28},{-71,-30}},
              lineColor={0,0,255},
              fillColor={0,0,255},
              ...
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{-76,-48},{-76,-34}},
            color={0,0,255}),Rectangle(
              extent={{-67,-25},{-63,-37}},
              lineColor={0,0,255},
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{-65,-37},{-65,-48}},
            color={0,0,255}),Line(points={{-65,-10},{-65,-25}}, color={0,0,255}),
            Line(points={{-76,-10},{-76,-28}}, color={0,0,255}),Rectangle(
              extent={{-45,-28},{-35,-30}},
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Rectangle(
              ...
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{-40,-48},{-40,-33}},
            color={0,0,255}),Rectangle(
              extent={{-31,-25},{-27,-37}},
              lineColor={0,0,255},
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{-29,-37},{-29,-48}},
            color={0,0,255}),Line(points={{-29,10},{-29,-25}}, color={0,0,255}),
            Line(points={{-40,10},{-40,-28}}, color={0,0,255}),Rectangle(
              extent={{-80,-48},{-26,-50}},
              ...
              lineColor={175,175,175},
              fillColor={175,175,175},
              fillPattern=FillPattern.Solid),Line(points={{20,10},{30,10}},
            color={0,0,255}),Line(points={{20,-10},{30,-10}}, color={0,0,255}),
            Rectangle(
              extent={{39,3},{49,1}},
              lineColor={0,0,255},
              fillColor={0,0,255},
              ...
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{20,10},{84,10}},
            color={0,0,255}),Line(points={{20,-10},{84,-10}}, color={0,0,255}),
            Line(points={{44,10},{44,3}}, color={0,0,255}),Line(points={{44,-3},
            {44,-10}}, color={0,0,255}),Line(points={{58,10},{58,6}}, color={0,
            0,255}),Line(points={{58,-6},{58,-10}}, color={0,0,255}),Rectangle(
              extent={{23,-28},{33,-30}},
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Rectangle(
              ...
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{28,-48},{28,-34}},
            color={0,0,255}),Rectangle(
              extent={{37,-25},{41,-37}},
              lineColor={0,0,255},
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{39,-37},{39,-48}},
            color={0,0,255}),Line(points={{39,-10},{39,-25}}, color={0,0,255}),
            Line(points={{28,-10},{28,-28}}, color={0,0,255}),Rectangle(
              extent={{59,-28},{69,-30}},
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Rectangle(
              ...
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{64,-48},{64,-33}},
            color={0,0,255}),Rectangle(
              extent={{73,-25},{77,-37}},
              lineColor={0,0,255},
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{75,-37},{75,-48}},
            color={0,0,255}),Line(points={{75,10},{75,-25}}, color={0,0,255}),
            Line(points={{64,10},{64,-28}}, color={0,0,255}),Rectangle(
              extent={{24,-48},{78,-50}},
              lineColor={135,135,135},
              fillColor={135,135,135},
              fillPattern=FillPattern.Solid)}));
  ...
  equation
    ...
    L*der(i) + diagonal(R)*i = [[2*(term_p.v - v[:, 1])], v[:, 1:ne - 1] - v[:,
...
"),   Icon(coordinateSystem(
      ...
      Diagram(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-100,-100},{100,100}},
          grid={2,2}), graphics={Line(points={{-84,10},{-74,10}}, color={0,0,
            255}),Rectangle(
              extent={{-74,12},{-64,8}},
              lineColor={0,0,255},
              lineThickness=0.5,
            ...
            points={{10,-6},{10,-10}}, color={0,0,255}),Rectangle(
              ...
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{-20,-48},{-20,-34}},
            color={0,0,255}),Rectangle(
              extent={{-11,-25},{-7,-37}},
              lineColor={0,0,255},
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{-9,-37},{-9,-48}},
            color={0,0,255}),Line(points={{-9,-10},{-9,-25}}, color={0,0,255}),
            Line(points={{-20,-10},{-20,-28}}, color={0,0,255}),Rectangle(
              extent={{11,-28},{21,-30}},
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Rectangle(
              ...
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{16,-48},{16,-33}},
            color={0,0,255}),Rectangle(
              extent={{25,-25},{29,-37}},
              lineColor={0,0,255},
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{27,-37},{27,-48}},
            color={0,0,255}),Line(points={{27,10},{27,-25}}, color={0,0,255}),
            Line(points={{16,10},{16,-28}}, color={0,0,255}),Rectangle(
              extent={{-24,-48},{30,-50}},
              lineColor={135,135,135},
              fillColor={135,135,135},
              fillPattern=FillPattern.Solid),Rectangle(
              ...
              lineColor={175,175,175},
              fillColor={175,175,175},
              fillPattern=FillPattern.Solid),Line(points={{76,10},{86,10}},
            color={0,0,255}),Line(points={{76,-10},{86,-10}}, color={0,0,255})}));
  end Tline;
...
"),   Icon(coordinateSystem(
      ...
      Diagram(coordinateSystem(
          ...
          grid={2,2}), graphics={Text(
              ...
              extent={{20,-80},{60,-100}},
              lineColor={95,95,95},
              textString="(1-p)"),Line(points={{-80,20},{-60,20}}, color={0,0,
            255}),Line(points={{-80,-20},{-60,-20}}, color={0,0,255}),Line(
            points={{60,35},{80,35}}, color={0,0,255}),Line(points={{60,0},{80,
            0}}, color={0,0,255}),Line(points={{60,-20},{80,-20}}, color={0,0,
            255}),Rectangle(
              extent={{-60,25},{-50,15}},
              lineColor={0,0,255},
              lineThickness=0.5,
              ...
              lineThickness=0.5,
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{-20,20},{20,20}},
            color={0,0,255}),Line(points={{-20,-20},{20,-20}}, color={0,0,255}),
            Line(points={{-10,20},{-10,80}}, color={0,0,255}),Line(points={{10,
            -20},{10,80}}, color={0,0,255}),Line(
              points={{-60,-70},{-20,-70}},
              color={95,95,95},
  ...
  equation
    ...
    C*der(v) + G*v = [i[:, 1:nF - 2] - i[:, 2:nF - 1], i[:, nF - 1:nF] - i[:,
      nF:nF + 1] - iF_p, i[:, nF + 1:ne] - i[:, nF + 2:ne1]];
    L*der(i) + diagonal(R)*i = [[2*(term_p.v - v[:, 1])], v[:, 1:ne - 1] - v[:,
      2:ne], [2*(v[:, ne] - term_n.v)]];
    L*der(iF) + diagonal(R)*iF = (v[:, nF - 1] - term_f.v)/pe + (v[:, nF] -
      term_f.v)/(1 - pe);
    annotation (
      defaultComponentName="faultLine",
      Documentation(info="<html>
...
<p><tt>p</tt> is restricted in such a way that faults do not occur in the end-elements of the line. Furthermore the position within an element is restricted to a relative position between <tt>0.1</tt> and <tt>0.9</tt> for numerical reasons.</p>
      ...
      Diagram(coordinateSystem(
          ...
          grid={2,2}), graphics={Text(
              ...
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{-20,10},{20,10}},
            color={0,0,255}),Line(points={{-20,-10},{20,-10}}, color={0,0,255}),
            Line(points={{-10,10},{-10,80}}, color={0,0,255}),Line(points={{10,
            -10},{10,80}}, color={0,0,255}),Line(points={{-80,10},{-60,10}},
            color={0,0,255}),Line(points={{-80,-10},{-60,-10}}, color={0,0,255}),
            Line(points={{60,10},{80,10}}, color={0,0,255}),Line(points={{60,-11},
            {80,-11}}, color={0,0,255})}));
  end FaultTline;
  ...
  package Partials "Partial models"
    ...
    protected
      ...
      final parameter SI.Inductance[2, 2] L=([(par.x + par.x0), (par.x0 - par.x);
          (par.x0 - par.x), (par.x + par.x0)]/2)*delta_len_km*RL_base[2];
...
"));
    ...
    protected
      final parameter Real[2] GC_base=Utilities.Precalculation.baseGC(
              ...
              par.S_nom,
              2*pi*par.f_nom);
      final parameter SI.Conductance[2, 2] G=[par.g_pg + par.g_pp, -par.g_pp; -
          par.g_pp, par.g_pg + par.g_pp]*delta_len_km*GC_base[1];
      final parameter SI.Capacitance[2, 2] C=[par.b_pg + par.b_pp, -par.b_pp; -
          par.b_pp, par.b_pg + par.b_pp]*delta_len_km*GC_base[2];
...
"));
  ...
  package Parameters "Parameter data for interactive use"
    ...
    record RXline "RX-line parameters, 1-phase"
      ...
      Generic.Resistance[2] r={0.1,0.1}*1e-3 "resistance/km" annotation (Dialog);
...
<p>More info see package AC1ph_DC.Impedances.</p>
    ...
    record Line "Line parameters, 1-phase"
      extends RXline;
      Generic.Conductance g_pg=0 "shunt conductance/km ph-grd"
        annotation (Dialog);
      Generic.Conductance g_pp=0 "shunt conductance/km ph_ph"
        annotation (Dialog);
...
<p>Coupling:</p>
<pre>  cpl = x_m/x_s &gt;  0,        positive for lines</pre>
<p>More info see package AC1ph_DC.Impedances.</p>
</html>
"));
end Lines;
