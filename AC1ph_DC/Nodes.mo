    ...
    annotation (
      ...
      Icon(coordinateSystem(
          ...
          grid={2,2}), graphics={Text(
              ...
              fillPattern=FillPattern.Solid),Line(points={{-40,-10},{-10,-10},{
            -10,-40},{40,-40}}, color={0,0,255}),Line(points={{-40,10},{-10,10},
