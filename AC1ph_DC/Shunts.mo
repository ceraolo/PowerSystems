...
<p>Info see package AC1ph_DC.Impedances.</p>
      ...
      Diagram(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(
              ...
              lineThickness=0.5,
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{-60,8},{-60,32}},
            color={0,0,255}),Line(points={{-60,-32},{-60,-8}}, color={0,0,255}),
            Line(points={{60,8},{60,32}}, color={0,0,255}),Line(points={{60,-32},
            {60,-8}}, color={0,0,255})}));
  end ReactiveShunt;

  model CapacitiveShunt
    "Shunt capacitor with parallel conductor, 1-phase, pp pg"
    extends Partials.ShuntBase;
...
<p>Info see package AC1ph_DC.Impedances.</p>
      ...
      Icon(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(
              ...
              fillPattern=FillPattern.Solid),Line(points={{-90,0},{-20,0}},
      ...
      Diagram(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(
              ...
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{36,30},{20,30},{20,
            10},{30,10}}, color={0,0,255}),Line(points={{36,-10},{20,-10},{20,-30},
            {30,-30}}, color={0,0,255}),Line(points={{44,30},{60,30},{60,10},{
            50,10}}, color={0,0,255}),Line(points={{44,-10},{60,-10},{60,-30},{
            50,-30}}, color={0,0,255}),Rectangle(
              extent={{-60,4},{-40,2}},
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Rectangle(
              ...
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{-50,4},{-50,16},{-30,
            16},{-30,10}}, color={0,0,255}),Line(points={{-50,-4},{-50,-16},{-30,
            -16},{-30,-10}}, color={0,0,255}),Line(points={{-60,20},{20,20}},
            color={0,0,255}),Line(points={{-60,-20},{20,-20}}, color={0,0,255}),
            Line(points={{-40,20},{-40,16}}, color={0,0,255}),Line(points={{-40,
            -20},{-40,-16}}, color={0,0,255}),Text(
              extent={{0,-40},{80,-50}},
              lineColor={0,0,255},
              lineThickness=0.5,
...
"), Diagram(coordinateSystem(
            preserveAspectRatio=false,
            extent={{-100,-100},{100,100}},
            grid={2,2}), graphics={Line(points={{60,20},{80,20}}, color={0,0,
              255}),Rectangle(
                  extent={{80,30},{84,10}},
                  lineColor={128,128,128},
                  fillColor={128,128,128},
                  fillPattern=FillPattern.Solid),Line(points={{60,-20},{80,-20}},
              color={0,0,255}),Rectangle(
                  extent={{80,-10},{84,-30}},
                  lineColor={128,128,128},
                  fillColor={128,128,128},
                  fillPattern=FillPattern.Solid),Line(points={{-80,20},{-60,20}},
              color={0,0,255}),Line(points={{-80,-20},{-60,-20}}, color={0,0,
              255})}));
    end ShuntBase;
