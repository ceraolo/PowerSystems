...
"),   Icon(coordinateSystem(
  ...
  package Partials "Partial models"
    ...
    partial model TrafoIdealBase "Base for ideal transformer, 1-phase"
      ...
      parameter PS.Current i2_start=i1_start "start value of secondary current"
        annotation (Dialog(tab="Initialization"));
    ...
    protected
      ...
      Real w2_set=(1 + (tap_2_internal - par.tap_neutral[2])*dv_tap_pu[2])*
          w_nom "2: set voltage ratio to nominal primary";
      ...
      annotation (
        Icon(coordinateSystem(
            ...
            grid={2,2}), graphics={Ellipse(
                  ...
                  lineColor={0,0,255},
                  fillColor={255,255,255},
                  fillPattern=FillPattern.Solid),Ellipse(extent={{-80,60},{40,-60}},
...
<p>Precalculation of coefficients for saturation transformer</p>
    ...
    protected
      ...
      Real w2a_set=(1 + (tap_2_internal[1] - par.tap_neutral[2])*dv_tap_pu[2])*
          wa_nom "2a: set voltage ratio to nominal primary";
      Real w2b_set=(1 + (tap_2_internal[2] - par.tap_neutral[3])*dv_tap_pu[3])*
          wb_nom "2b: set voltage ratio to nominal primary";
