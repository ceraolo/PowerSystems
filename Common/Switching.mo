...
"),   Icon(coordinateSystem(
  ...
  equation
    ...
    {v,i} = if closed then {epsR*s,s} else if arc then {v_arc,i_arc} else {s,
      epsG*s};
    annotation (
      defaultComponentName="breaker_",
      Documentation(info="<html>
...
When closing: <tt>arc</tt> becomes false (<tt>open</tt> changes from true to false).</p>
      ...
      Icon(coordinateSystem(
          ...
          extent={{-100,-100},{100,100}},
          grid={2,2}), graphics={Line(
              points={{-40,0},{-30,-4},{-24,0},{-14,-2},{-4,4},{2,0},{10,-2},{
              18,2},{26,-2},{30,-2},{34,2},{40,0}},
              color={255,255,0},
              thickness=0.5)}));
  end Breaker;
  ...
  model Short
    ...
    parameter SI.Time t_c=10e-3 "relaxation time constant"
      annotation (Dialog(enable=relax));
...
<pre>
  ...
  protected
    ...
    replaceable Plasma.ArcFault arcFault(V=Varc, r=R0/Varc)
...
"),     Icon(coordinateSystem(
        ...
        Diagram(coordinateSystem(
            preserveAspectRatio=false,
            extent={{-100,-100},{100,100}},
            grid={2,2}), graphics={Line(points={{-80,0},{-60,0}}, color={95,95,
              95}),Line(
                  points={{-60,0},{-30,0},{30,20}},
                  color={95,95,95},
                  thickness=0.5),Line(points={{30,0},{80,0}}, color={95,95,95}),
              Line(
                  points={{0,90},{0,10}},
                  color={255,0,255},
                  pattern=LinePattern.Dot)}));
