...
package Thermal "Thermal boundary and adaptors"
  ...
  model BdCond "Default (Neumann) boundary condition, scalar port"
    ...
    Interfaces.Thermal_p heat "heat port" annotation (Placement(transformation(
          origin={0,-100},
          extent={{-10,-10},{10,10}},
          rotation=90)));
...
"));
  ...
  model Boundary "Boundary model, scalar port"
    ...
    PowerSystems.Interfaces.Thermal_p heat "heat port" annotation (Placement(
          transformation(
          origin={0,-100},
          extent={{-10,-10},{10,10}},
          rotation=90)));
...
"));
  ...
  model Heat_a_b_ab "Adaptor 2 x Thermal (scalar) to ThermalV (vector)"
    ...
    PowerSystems.Interfaces.Thermal_p port_a "scalar port a" annotation (
        Placement(transformation(
          origin={-40,-60},
          extent={{-10,-10},{10,10}},
          rotation=90)));
    PowerSystems.Interfaces.Thermal_p port_b "scalar port b" annotation (
        Placement(transformation(
          origin={40,-60},
          extent={{-10,-10},{10,10}},
          rotation=90)));
    PowerSystems.Interfaces.ThermalV_n port_ab(final m=2) "vector port {a,b}"
      annotation (Placement(transformation(
          origin={0,60},
          extent={{-10,-10},{10,10}},
          rotation=90)));
  ...
  equation
    ...
    annotation (
      defaultComponentName="heat_adapt",
      Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
              100,100}}), graphics={Line(points={{-40,-40},{-40,0},{-5,0},{-5,
            40}}, color={176,0,0}),Line(points={{40,-40},{40,0},{5,0},{5,40}},
            color={176,0,0})}),
      Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,
              ...
              fillPattern=FillPattern.Solid),Line(points={{-40,-38},{-40,0},{-10,
            0},{-10,40}}, color={176,0,0}),Line(points={{40,-40},{40,0},{10,0},
            {10,40}}, color={176,0,0}),Text(
  ...
  model Heat_a_b_c_abc "Adaptor 3 x Thermal (scalar) to ThermalV (vector)"
    ...
    PowerSystems.Interfaces.Thermal_p port_b "scalar port b" annotation (
        Placement(transformation(
          ...
          extent={{-10,-10},{10,10}},
          rotation=90)));
    PowerSystems.Interfaces.Thermal_p port_c "scalar port c" annotation (
        Placement(transformation(
          origin={40,-60},
          extent={{-10,-10},{10,10}},
          rotation=90)));
    PowerSystems.Interfaces.ThermalV_n port_abc(final m=3)
      "vector port {a,b,c}" annotation (Placement(transformation(
          origin={0,60},
          extent={{-10,-10},{10,10}},
          rotation=90)));
  ...
  equation
    ...
    {port_a.Q_flow,port_b.Q_flow,port_c.Q_flow} + port_abc.ports.Q_flow = zeros(
      3);
    annotation (
      defaultComponentName="heat_adapt",
      Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
              100,100}}), graphics={Line(points={{-40,-40},{-40,0},{-5,0},{-5,
            40}}, color={176,0,0}),Line(points={{0,-40},{0,40}}, color={176,0,0}),
      ...
      Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,
              ...
              fillPattern=FillPattern.Solid),Line(points={{-40,-38},{-40,0},{-10,
            0},{-10,40}}, color={176,0,0}),Line(points={{40,-40},{40,0},{10,0},
            {10,40}}, color={176,0,0}),Line(points={{0,-40},{0,40}}, color={176,
            0,0}),Text(
              extent={{-100,-100},{100,-140}},
              lineColor={0,0,0},
              textString="%name"),Text(
  ...
  model HeatV_a_b_ab "Adaptor 2 x ThermalV (vector) to ThermalV (vector)"
    ...
    PowerSystems.Interfaces.ThermalV_p port_b(final m=m[2]) "vector port b"
      annotation (Placement(transformation(
          ...
          extent={{-10,-10},{10,10}},
          rotation=90)));
    PowerSystems.Interfaces.ThermalV_n port_ab(final m=sum(m))
      "vector port {a,b}" annotation (Placement(transformation(
          origin={0,60},
          extent={{-10,-10},{10,10}},
          rotation=90)));
  ...
  equation
    cat(1,
        port_a.ports.T,
        port_b.ports.T) = port_ab.ports.T;
    cat(1,
        port_a.ports.Q_flow,
        port_b.ports.Q_flow) + port_ab.ports.Q_flow = zeros(sum(m));
    annotation (
      defaultComponentName="heat_adapt",
      Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
              100,100}}), graphics={Line(points={{-40,-40},{-40,0},{-5,0},{-5,
  ...
  model HeatV_a_b_c_abc "Adaptor 3 x Thermal (scalar) to ThermalV (vector)"
    ...
    PowerSystems.Interfaces.ThermalV_p port_a(final m=m[1]) "scalar port a"
      annotation (Placement(transformation(
          origin={-40,-60},
          extent={{-10,-10},{10,10}},
          rotation=90)));
    PowerSystems.Interfaces.ThermalV_p port_b(final m=m[2]) "scalar port b"
      annotation (Placement(transformation(
          origin={0,-60},
          extent={{-10,-10},{10,10}},
          rotation=90)));
    PowerSystems.Interfaces.ThermalV_p port_c(final m=m[3]) "scalar port c"
      annotation (Placement(transformation(
          origin={40,-60},
          extent={{-10,-10},{10,10}},
          rotation=90)));
    PowerSystems.Interfaces.ThermalV_n port_abc(final m=sum(m))
      "vector port {a,b,c}" annotation (Placement(transformation(
          origin={0,60},
          extent={{-10,-10},{10,10}},
          rotation=90)));
  ...
  equation
    cat(1,
        port_a.ports.T,
        port_b.ports.T,
        port_c.ports.T) = port_abc.ports.T;
    cat(1,
        port_a.ports.Q_flow,
        port_b.ports.Q_flow,
        port_c.ports.Q_flow) + port_abc.ports.Q_flow = zeros(sum(m));
    annotation (
      defaultComponentName="heat_adapt",
      Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
              100,100}}), graphics={Line(points={{-40,-40},{-40,0},{-5,0},{-5,
  ...
  model HeatV_S "Collector ThermalV (vector) to Thermal (scalar)"
    ...
    PowerSystems.Interfaces.ThermalV_p port_a(final m=m) "vector port"
      annotation (Placement(transformation(
          origin={0,-58},
          extent={{-10,-10},{10,10}},
          rotation=90)));
    PowerSystems.Interfaces.Thermal_n port_b "scalar port" annotation (
        Placement(transformation(
          origin={0,60},
          extent={{-10,-10},{10,10}},
          rotation=90)));
  ...
  equation
    ...
    annotation (
      defaultComponentName="heat_collect",
      Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,
              100}}), graphics={Rectangle(
              extent={{-60,40},{60,-40}},
              lineColor={255,255,255},
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{-10,-40},{-10,0},{0,
            0},{0,40}}, color={176,0,0}),Line(points={{10,-40},{10,0},{0,0},{0,
            40}}, color={176,0,0}),Text(
              extent={{-100,-100},{100,-140}},
              lineColor={0,0,0},
              textString="%name")}),
      Documentation(info="<html>
...
"));
    ...
    partial model BoundaryBase "Boundary model base"
      ...
      parameter SI.HeatCapacity C=1 "heat capacity cp*m"
        annotation (Dialog(enable=not ideal));
      ...
      annotation (
        ...
        Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
                100,100}}), graphics={Rectangle(
                  ...
                  lineColor={255,255,255},
                  fillColor={255,255,255},
                  fillPattern=FillPattern.Solid),Line(points={{-50,20},{-40,40},
              {-30,20}}, color={191,0,0}),Line(points={{-10,20},{0,40},{10,20}},
              color={191,0,0}),Line(points={{30,20},{40,40},{50,20}}, color={
              191,0,0}),Line(points={{-40,-50},{-40,-40}}, color={191,0,0}),
              Line(points={{0,-50},{0,-40}}, color={191,0,0}),Line(points={{40,
              -50},{40,-40}}, color={191,0,0}),Line(points={{-40,0},{-40,40}},
              color={191,0,0}),Line(points={{0,0},{0,40}}, color={191,0,0}),
              Line(points={{40,0},{40,40}}, color={191,0,0}),Text(
                  extent={{-100,0},{100,-40}},
                  lineColor={0,0,0},
                  textString="%name")}),
        Documentation(info="<html>
