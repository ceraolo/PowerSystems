...
<p>Info see package ACdq0.ImpedancesYD.</p>
  ...
  model LoadImped_RXX "Inductor with series resistor, 3-phase dq0"
...
"),   Icon(coordinateSystem(
      ...
      Diagram(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(
              ...
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{8,22},{6,18},{-46,16},
            {-48,12}}, color={0,0,0}),Line(points={{8,5},{6,1},{-46,-1},{-48,-5}},
            color={0,0,0}),Line(points={{8,-11},{6,-15},{-46,-17},{-48,-21}},
            color={0,0,0})}));
  end Varistor;
  ...
  package Partials "Partial models"
    ...
    partial model ImpedYDBase "One terminal impedance base, 3-phase dq0"
      ...
      parameter Generic.Resistance r_n=1 "resistance neutral to grd"
