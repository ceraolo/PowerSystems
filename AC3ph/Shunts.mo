...
<p>Info see package ACabc.Impedances.</p>
      ...
      Diagram(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(
              ...
              lineThickness=0.5,
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{-60,38},{-60,62}},
            color={0,0,255}),Line(points={{-60,-12},{-60,12}}, color={0,0,255}),
            Line(points={{-60,-62},{-60,-38}}, color={0,0,255}),Line(points={{
            60,-12},{60,12}}, color={0,0,255}),Line(points={{60,38},{60,62}},
            color={0,0,255}),Line(points={{60,-62},{60,-38}}, color={0,0,255})}));
  end ReactiveShunt;
...
"),   Icon(coordinateSystem(
      ...
      Diagram(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(
              ...
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{36,60},{20,60},{20,
            40},{30,40}}, color={0,0,255}),Line(points={{36,10},{20,10},{20,-10},
            {30,-10}}, color={0,0,255}),Line(points={{36,-40},{20,-40},{20,-60},
            {30,-60}}, color={0,0,255}),Line(points={{44,60},{60,60},{60,40},{
            50,40}}, color={0,0,255}),Line(points={{44,10},{60,10},{60,-10},{50,
            -10}}, color={0,0,255}),Line(points={{44,-40},{60,-40},{60,-60},{50,
            -60}}, color={0,0,255}),Rectangle(
              extent={{-70,28},{-50,26}},
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Rectangle(
              ...
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{-60,28},{-60,40},{-40,
            40},{-40,34}}, color={0,0,255}),Line(points={{-60,20},{-60,8},{-40,
            8},{-40,14}}, color={0,0,255}),Rectangle(
              extent={{-70,-22},{-50,-24}},
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Rectangle(
              ...
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{-60,-22},{-60,-10},{
            -40,-10},{-40,-16}}, color={0,0,255}),Line(points={{-60,-30},{-60,-42},
            {-40,-42},{-40,-36}}, color={0,0,255}),Rectangle(
              extent={{-30,4},{-10,2}},
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Rectangle(
              ...
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{-20,4},{-20,16},{0,
            16},{0,10}}, color={0,0,255}),Line(points={{-20,-4},{-20,-16},{0,-16},
            {0,-10}}, color={0,0,255}),Line(points={{-60,50},{20,50}}, color={0,
            0,255}),Line(
              points={{-60,0},{20,0}},
              color={0,0,255},
            ...
            Text(
              extent={{-80,-60},{0,-70}},
              lineColor={0,0,255},
              textString="b_pp, g_pp"),Text(
              extent={{0,-80},{80,-90}},
              lineColor={0,0,255},
              textString="g_pg"),Text(
              extent={{0,-70},{80,-80}},
              lineColor={0,0,255},
              textString="b_pg")}));
  end CapacitiveShunt;
  ...
  equation
    ...
    annotation (
      defaultComponentName="xShuntNonSym",
      Documentation(info="<html>
...
"),   Icon(coordinateSystem(
      ...
      Diagram(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(
            ...
            color={0,0,255}),Line(points={{-60,-12},{-60,12}}, color={0,0,255}),
            Line(points={{-60,-62},{-60,-38}}, color={0,0,255}),Line(points={{
            60,38},{60,62}}, color={0,0,255}),Line(points={{60,-12},{60,12}},
            color={0,0,255}),Line(points={{60,-62},{60,-38}}, color={0,0,255})}));
  ...
  protected
    final parameter SI.Resistance[2] GC_base=Utilities.Precalculation.baseGC(
          ...
          S_nom,
          2*pi*f_nom);
    final parameter SI.Conductance[3, 3] G_abc=(diagonal(g_pg) + [g_pp[2] +
        g_pp[3], -g_pp[3], -g_pp[2]; -g_pp[3], g_pp[3] + g_pp[1], -g_pp[1]; -
        g_pp[2], -g_pp[1], g_pp[1] + g_pp[2]])*GC_base[1];
    final parameter SI.Capacitance[3, 3] C_abc=(diagonal(b_pg) + [b_pp[2] +
        b_pp[3], -b_pp[3], -b_pp[2]; -b_pp[3], b_pp[3] + b_pp[1], -b_pp[1]; -
        b_pp[2], -b_pp[1], b_pp[1] + b_pp[2]])*GC_base[2];
    SI.Conductance[3, 3] G;
  ...
  equation
    ...
    annotation (
      defaultComponentName="cShuntNonSym",
      Documentation(info="<html>
...
"), Diagram(coordinateSystem(
            preserveAspectRatio=false,
            extent={{-100,-100},{100,100}},
            grid={2,2}), graphics={Line(points={{60,50},{80,50}}, color={0,0,
              255}),Line(points={{60,0},{80,0}}, color={0,0,255}),Line(points={
              {60,-50},{80,-50}}, color={0,0,255}),Rectangle(
                  extent={{80,10},{84,-10}},
                  ...
                  lineColor={128,128,128},
                  fillColor={128,128,128},
                  fillPattern=FillPattern.Solid),Line(points={{-80,50},{-60,50}},
              color={0,0,255}),Line(points={{-80,0},{-60,0}}, color={0,0,255}),
