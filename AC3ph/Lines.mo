...
"),
      ...
      Diagram(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-100,-100},{100,100}},
          grid={2,2}), graphics={Line(points={{-80,35},{-60,35}}, color={0,0,
            255}),Line(points={{-80,0},{-60,0}}, color={0,0,255}),Line(points={
            {-80,-35},{-60,-35}}, color={0,0,255}),Rectangle(
              extent={{-60,40},{-40,30}},
              lineColor={0,0,255},
              lineThickness=0.5,
              fillColor={255,255,255},
              ...
              lineColor={175,175,175},
              fillColor={175,175,175},
              fillPattern=FillPattern.Solid),Line(points={{60,35},{80,35}},
            color={0,0,255}),Line(points={{60,0},{80,0}}, color={0,0,255}),Line(
            points={{60,-35},{80,-35}}, color={0,0,255})}));
  end RXline;
  ...
  equation
    ...
    if dynType <> Types.Dynamics.SteadyState then
      diagonal(PS.map({C,C,C0}))*der(v) + omega[2]*C*jj(v) + G*v = [[2*(term_p.i
         - i[:, 1])], i[:, 1:ne - 1] - i[:, 2:ne], [2*(i[:, ne] + term_n.i)]];
      diagonal(PS.map({L,L,L0}))*der(i) + omega[2]*L*jj(i) + R*i = v[:, 1:ne]
         - v[:, 2:ne1];
    else
      omega[2]*C*jj(v) + G*v = [[2*(term_p.i - i[:, 1])], i[:, 1:ne - 1] - i[:,
        2:ne], [2*(i[:, ne] + term_n.i)]];
      omega[2]*L*jj(i) + R*i = v[:, 1:ne] - v[:, 2:ne1];
    end if;
    annotation (
      defaultComponentName="line1",
      Documentation(info="<html>
...
It is composed of <tt>ne</tt> interior elements of length <tt>delta</tt>. Therefore it contains <tt>ne+1</tt> nodes. Each element corresponds to a series resistor-inductor with values R and L corresponding to its length. A shunt parallel capacitor-conductor is linked to each node.<br>
The minimum of ne is 1.</p>
</html>"),
      Icon(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-100,-100},{100,100}},
      ...
      Diagram(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-100,-100},{100,100}},
          grid={2,2}), graphics={Line(points={{-30,18},{-20,18}}, color={0,0,
            255}),Rectangle(
              extent={{-16,20},{-8,16}},
              lineColor={0,0,255},
              lineThickness=0.5,
              ...
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{12,18},{84,18}},
            color={0,0,255}),Line(points={{-30,0},{-20,0}}, color={0,0,255}),
            Line(
              points={{42,0},{82,0}},
              color={0,0,255},
            ...
            51,-2},{51,-18}}, color={0,0,255}),Line(points={{62,18},{62,6}},
            color={0,0,255}),Line(points={{62,-6},{62,-18}}, color={0,0,255}),
            Line(points={{40,18},{40,16}}, color={0,0,255}),Line(points={{40,-16},
            {40,-18}}, color={0,0,255}),Line(points={{40,4},{40,-4}}, color={0,
            0,255}),Line(points={{12,0},{44,0}}, color={0,0,255}),Rectangle(
              extent={{22,-37},{32,-39}},
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Rectangle(
              ...
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{27,-60},{27,-42}},
            color={0,0,255}),Rectangle(
              extent={{34,-34},{38,-46}},
              lineColor={0,0,255},
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{36,-46},{36,-60}},
            color={0,0,255}),Line(points={{36,-18},{36,-34}}, color={0,0,255}),
            Line(points={{27,-18},{27,-37}}, color={0,0,255}),Rectangle(
              extent={{40,-37},{50,-39}},
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Rectangle(
              ...
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{45,-60},{45,-42}},
            color={0,0,255}),Rectangle(
              extent={{56,-34},{60,-46}},
              lineColor={0,0,255},
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{58,-46},{58,-60}},
            color={0,0,255}),Rectangle(
              extent={{61,-37},{71,-39}},
              lineColor={0,0,255},
              fillColor={0,0,255},
              ...
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{66,-60},{66,-42}},
            color={0,0,255}),Rectangle(
              extent={{73,-34},{77,-46}},
              lineColor={0,0,255},
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{75,-46},{75,-60}},
            color={0,0,255}),Line(points={{75,18},{75,-34}}, color={0,0,255}),
            Line(points={{66,18},{66,-37}}, color={0,0,255}),Line(points={{58,0},
            {58,-28},{58,-28},{58,-34}}, color={0,0,255}),Line(points={{45,0},{
            45,-28},{45,-28},{45,-38}}, color={0,0,255}),Rectangle(
              extent={{22,-60},{80,-62}},
            ...
            ={0,0,255}),Rectangle(
              ...
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{-84,18},{-16,18}},
            color={0,0,255}),Line(
              points={{-60,0},{-16,0}},
              color={0,0,255},
            ...
            points={{-40,18},{-40,6}}, color={0,0,255}),Line(points={{-40,-6},{
            -40,-18}}, color={0,0,255}),Line(points={{-62,18},{-62,16}}, color=
            {0,0,255}),Line(points={{-62,-16},{-62,-18}}, color={0,0,255}),Line(
            points={{-62,4},{-62,-4}}, color={0,0,255}),Line(points={{-84,0},{-58,
            0}}, color={0,0,255}),Rectangle(
              extent={{-80,-37},{-70,-39}},
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Rectangle(
              ...
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{-73,-60},{-73,-42}},
            color={0,0,255}),Rectangle(
              extent={{-68,-34},{-64,-46}},
              lineColor={0,0,255},
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{-66,-46},{-66,-60}},
            color={0,0,255}),Line(points={{-66,-18},{-66,-34}}, color={0,0,255}),
            Line(points={{-73,-18},{-73,-37}}, color={0,0,255}),Rectangle(
              extent={{-62,-37},{-52,-39}},
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Rectangle(
              ...
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{-57,-60},{-57,-42}},
            color={0,0,255}),Rectangle(
              extent={{-46,-34},{-42,-46}},
              lineColor={0,0,255},
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{-44,-46},{-44,-60}},
            color={0,0,255}),Rectangle(
              extent={{-41,-37},{-31,-39}},
              lineColor={0,0,255},
              fillColor={0,0,255},
              ...
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{-36,-60},{-36,-42}},
            color={0,0,255}),Rectangle(
              extent={{-29,-34},{-25,-46}},
              lineColor={0,0,255},
              lineThickness=0.5,
              fillColor={255,255,255},
              fillPattern=FillPattern.Solid),Line(points={{-27,-46},{-27,-60}},
            color={0,0,255}),Line(points={{-27,18},{-27,-34}}, color={0,0,255}),
            Line(points={{-36,18},{-36,-37}}, color={0,0,255}),Line(points={{-44,
            0},{-44,-28},{-44,-28},{-44,-34}}, color={0,0,255}),Line(points={{-57,
            0},{-57,-28},{-57,-28},{-57,-38}}, color={0,0,255}),Rectangle(
              extent={{-80,-60},{-22,-62}},
              lineColor={135,135,135},
              fillColor={135,135,135},
              fillPattern=FillPattern.Solid)}));
  ...
  equation
    ...
    if dynType <> Types.Dynamics.SteadyState then
      diagonal(PS.map({C,C,C0}))*der(v) + omega[2]*C*jj(v) + G*v = i[:, 1:ne]
         - i[:, 2:ne1];
      diagonal(PS.map({L,L,L0}))*der(i) + omega[2]*L*jj(i) + R*i = [[2*(term_p.v
         - v[:, 1])], v[:, 1:ne - 1] - v[:, 2:ne], [2*(v[:, ne] - term_n.v)]];
    else
      omega[2]*C*jj(v) + G*v = i[:, 1:ne] - i[:, 2:ne1];
      omega[2]*L*jj(i) + R*i = [[2*(term_p.v - v[:, 1])], v[:, 1:ne - 1] - v[:,
        2:ne], [2*(v[:, ne] - term_n.v)]];
    end if;
    annotation (
      defaultComponentName="line1",
      Documentation(info="<html>
...
<p>The line of total length <tt>len</tt> is divided into elements of length <tt>delta = len/ne</tt>.
It is composed of <tt>ne-1</tt> interior elements of length <tt>delta</tt> and at each end of a half-element of length <tt>delta/2</tt>. Therefore it contains <tt>n</tt> interior nodes. Each element corresponds to a series resistor-inductor with values R and L corresponding to its length. A shunt parallel capacitor-conductor is linked to each node.<br>
The minimum of ne is 1.</p>
...
The set of equations of two series connected lines of length len1 and len2 is identical to the set of equations for one line of length len1 + len2 if delta1 = delta2. Otherwise differences occur from the different discretisation length.</p>
  ...
  model FaultRXline "Faulted RX transmission line, 3-phase dq0"
    ...
    parameter Real p(
      min=0,
      max=1) = 0.5 "rel fault-position (0 < p < 1)";
    extends Partials.RXlineBase(final ne=1);
  ...
  equation
    ...
    if dynType <> Types.Dynamics.SteadyState then
      p*(PS.map({L,L,L0}) .* der(i1) + omega[2]*L*j(i1) + R*i1) = term_p.v -
        term_f.v;
      (1 - p)*(PS.map({L,L,L0}) .* der(i2) + omega[2]*L*j(i2) + R*i2) = term_f.v
         - term_n.v;
    else
...
"),
      ...
      Diagram(coordinateSystem(
          ...
          grid={2,2}), graphics={Text(
              ...
              extent={{20,-80},{60,-100}},
              lineColor={95,95,95},
              textString="(1-p)"),Line(points={{-80,35},{-60,35}}, color={0,0,
            255}),Line(points={{-80,0},{-60,0}}, color={0,0,255}),Line(points={
            {-80,-35},{-60,-35}}, color={0,0,255}),Line(points={{60,35},{80,35}},
            color={0,0,255}),Line(points={{60,0},{80,0}}, color={0,0,255}),Line(
            points={{60,-35},{80,-35}}, color={0,0,255}),Rectangle(
              extent={{-60,40},{-50,30}},
              lineColor={0,0,255},
              lineThickness=0.5,
              fillColor={255,255,255},
              ...
              lineColor={175,175,175},
              fillColor={175,175,175},
              fillPattern=FillPattern.Solid),Line(points={{-20,35},{20,35}},
            color={0,0,255}),Line(points={{-20,0},{20,0}}, color={0,0,255}),
            Line(points={{-20,-35},{20,-35}}, color={0,0,255}),Line(points={{-10,
            35},{-10,80}}, color={0,0,255}),Line(points={{0,0},{0,80}}, color={
            0,0,255}),Line(points={{10,-35},{10,80}}, color={0,0,255}),Line(
              points={{-60,-70},{-20,-70}},
              color={95,95,95},
  ...
  model FaultTline "Faulted T transmission line, 3-phase dq0"
    ...
    parameter Real p(
      min=0.5/ne,
      max=1 - 0.5/ne) = 0.5 "rel fault-pos (1/2ne <= p < 1 - 1/2ne)";
    extends Partials.LineBase;

    parameter PS.Current[PS.n] iF_start=zeros(PS.n)
      "start value of fault current" annotation (Dialog(tab="Initialization"));
  ...
  equation
    ...
    if dynType <> Types.Dynamics.SteadyState then
      diagonal(PS.map({C,C,C0}))*der(v) + omega[2]*C*jj(v) + G*v = [i[:, 1:nF
         - 2] - i[:, 2:nF - 1], i[:, nF - 1:nF] - i[:, nF:nF + 1] - iF_p, i[:,
        nF + 1:ne] - i[:, nF + 2:ne1]];
      diagonal(PS.map({L,L,L0}))*der(i) + omega[2]*L*jj(i) + R*i = [[2*(term_p.v
         - v[:, 1])], v[:, 1:ne - 1] - v[:, 2:ne], [2*(v[:, ne] - term_n.v)]];
      PS.map({L,L,L0}) .* der(iF) + omega[2]*L*j(iF) + R*iF = (v[:, nF - 1] -
        term_f.v)/pe + (v[:, nF] - term_f.v)/(1 - pe);
    else
      omega[2]*C*jj(v) + G*v = [i[:, 1:nF - 2] - i[:, 2:nF - 1], i[:, nF - 1:nF]
         - i[:, nF:nF + 1] - iF_p, i[:, nF + 1:ne] - i[:, nF + 2:ne1]];
      omega[2]*L*jj(i) + R*i = [[2*(term_p.v - v[:, 1])], v[:, 1:ne - 1] - v[:,
        2:ne], [2*(v[:, ne] - term_n.v)]];
      omega[2]*L*j(iF) + R*iF = (v[:, nF - 1] - term_f.v)/pe + (v[:, nF] -
        term_f.v)/(1 - pe);
    end if;
    annotation (
      defaultComponentName="faultLine",
...
<p><tt>p</tt> is restricted in such a way that faults do not occur in the end-elements of the line. Furthermore the position within an element is restricted to a relative position between <tt>0.1</tt> and <tt>0.9</tt> for numerical reasons.</p>
      ...
      Diagram(coordinateSystem(
          ...
          grid={2,2}), graphics={Text(
              ...
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{-20,11},{20,11}},
            color={0,0,255}),Line(points={{-20,0},{20,0}}, color={0,0,255}),
            Line(points={{-20,-11},{20,-11}}, color={0,0,255}),Line(points={{-10,
            11},{-10,80}}, color={0,0,255}),Line(points={{0,0},{0,80}}, color={
            0,0,255}),Line(points={{10,-11},{10,80}}, color={0,0,255}),Line(
            points={{-80,11},{-60,11}}, color={0,0,255}),Line(points={{-80,0},{
            -60,0}}, color={0,0,255}),Line(points={{-80,-11},{-60,-11}}, color=
            {0,0,255}),Line(points={{60,11},{80,11}}, color={0,0,255}),Line(
            points={{60,0},{80,0}}, color={0,0,255}),Line(points={{60,-11},{80,
            -11}}, color={0,0,255})}));
  end FaultTline;
  ...
  package Partials "Partial models"
    ...
    protected
      ...
      final parameter SI.Resistance[2] RL_base=Utilities.Precalculation.baseRL(
              ...
              par.S_nom,
              2*pi*par.f_nom);
      final parameter Real delta_len_km(
        final quantity="Length",
        final unit="km") = len/1e3/ne;
...
"));
    ...
    protected
      final parameter Real[2] GC_base=Utilities.Precalculation.baseGC(
              ...
              par.S_nom,
              2*pi*par.f_nom);
      final parameter SI.Conductance G=(par.g_pg + 3*par.g_pp)*delta_len_km*
          GC_base[1];
      final parameter SI.Capacitance C=(par.b_pg + 3*par.b_pp)*delta_len_km*
          GC_base[2];
...
"));
    ...
    record Line "Line parameters, 3-phase"
      ...
      Types.Generic.Conductance_km g_pg=0 "shunt conductance/km ph-grd"
        annotation (Dialog);
      Types.Generic.Conductance_km g_pp=0 "shunt conductance/km ph_ph"
        annotation (Dialog);
      Types.Generic.Susceptance_km b_pg=0.025e-3 "susceptance/km ph-grd"
        annotation (Dialog);
      Types.Generic.Susceptance_km b_pp=0.025e-3 "susceptance/km ph-ph"
        annotation (Dialog);
