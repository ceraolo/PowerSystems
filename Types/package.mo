...
type SystemFrequency = enumeration(
  ...
  "Options for specification of frequency in system object" annotation (
...
type Dynamics = enumeration(
    ...
    SteadyState "Steady-state (quasi-stationary)")
  "Options for specification of simulation" annotation (Documentation(info="<html>
<p><pre>
...
type Init = enumeration(
    ...
    none "none: no initial condition") "Initialization type" annotation (
    Documentation(info="<html>
<p><pre>
