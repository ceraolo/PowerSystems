  ...
  partial model Adaptor_abc "Adaptor icon abc"
    ...
    annotation (Icon(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(
              ...
              extent={{-60,62},{0,22}},
              lineColor={0,130,175},
              textString="~"),Line(points={{-46,30},{-14,30}}, color={0,130,175}),
            Text(
              extent={{-60,22},{0,-18}},
              lineColor={0,130,175},
              textString="~"),Line(points={{-46,-10},{-14,-10}}, color={0,130,
            175}),Line(points={{-46,-50},{-14,-50}}, color={0,130,175}),Text(
              extent={{-60,-18},{0,-58}},
              lineColor={0,130,175},
              textString="~"),Text(
  ...
  partial model Adaptor_dq0 "Adaptor icon dq0"
    ...
    annotation (Icon(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(
              ...
              extent={{-60,62},{0,22}},
              lineColor={0,120,120},
              textString="~"),Line(points={{-46,30},{-14,30}}, color={0,120,120}),
            Text(
              extent={{-60,22},{0,-18}},
              lineColor={0,120,120},
              textString="~"),Line(points={{-46,-10},{-14,-10}}, color={0,120,
            120}),Line(points={{-46,-40},{-14,-40}}, color={0,120,120}),Text(
              extent={{-100,-90},{100,-130}},
              lineColor={0,0,0},
              textString="%name")}), Documentation(info=""));
  ...
  partial model Inverter_abc "Inverter icon"
    ...
    annotation (Icon(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(
            ...
            color={0,130,175}),Line(points={{24,-40},{56,-40}}, color={0,130,
            175}),Line(points={{24,-20},{56,-20}}, color={0,130,175}),Text(
              extent={{-100,-90},{100,-130}},
              lineColor={0,0,0},
              ...
              lineColor={0,130,175},
              lineThickness=0.5,
              textString="~"),Line(points={{24,0},{56,0}}, color={0,130,175}),
            Text(
              extent={{10,0},{70,-30}},
              lineColor={0,130,175},
              lineThickness=0.5,
              ...
              extent={{10,-20},{70,-50}},
              lineColor={0,130,175},
              textString="~"),Text(extent={{-80,40},{0,0}}, textString="=")}),
        Documentation(info=""));
