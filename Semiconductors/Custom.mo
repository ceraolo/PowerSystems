...
"),
      Icon(coordinateSystem(
          ...
          grid={2,2}), graphics={Polygon(
            ...
            points={{40,40},{40,-40}}, color={0,0,255}),Line(points={{-100,-100},
    ...
    annotation (
      ...
      Icon(coordinateSystem(
          ...
          grid={2,2}), graphics={Polygon(
              ...
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{0,40},{24,26}},
            color={0,0,255}),Line(points={{90,0},{80,0}}, color={0,0,255}),Line(
            points={{60,60},{60,90}}, color={255,0,255}),Line(points={{-70,40},
            {70,40}}, color={0,0,255}),Line(points={{-70,60},{70,60}}, color={0,
            0,255}),Line(points={{-90,0},{-80,0},{-20,40}}, color={0,0,255}),
      ...
      Icon(coordinateSystem(
          ...
          grid={2,2}), graphics={Polygon(
            ...
            points={{20,40},{20,-40}}, color={0,0,255}),Line(
              ...
              color={255,0,255},
              pattern=LinePattern.Dot),Line(points={{-100,-100},{100,100}},
            color={255,0,0})}));
  end Thyristor;
