...
package PhaseModules "Phase modules"
  ...
  choice(redeclare package SCpackage=Semiconductors.Custom "custom")));*/
    ...
    SCpackage.Diode diode1(final par=par) "diode DC_p" annotation (Placement(
          transformation(
          origin={0,30},
          extent={{-10,-10},{10,10}},
          rotation=90)));
    SCpackage.Diode diode2(final par=par) "diode DC_n" annotation (Placement(
          transformation(
          origin={0,-30},
          extent={{-10,-10},{10,10}},
          rotation=90)));
  ...
  equation
    connect(AC, diode1.term_p) annotation (Line(points={{100,0},{-6.12303e-016,
            0},{-6.12303e-016,20}},color={0,0,255}));
    connect(diode1.term_n, pn_p_n.term_p) annotation (Line(points={{
            6.12303e-016,40},{0,40},{0,50},{-40,50},{-40,4},{-44,4}}, color={0,
            0,255}));
    ...
    connect(diode2.heat, heat) annotation (Line(points={{-10,-30},{-20,-30},{-20,
            80},{0,80},{0,100}}, color={176,0,0}));
    annotation (
      defaultComponentName="diodeMod1",
...
"),   Icon(coordinateSystem(
          ...
          grid={2,2}), graphics={Polygon(
            ...
            {80,0}}, color={0,0,255}),Line(points={{-80,10},{-60,10},{-60,50},{
            0,50},{0,38}}, color={0,0,255}),Line(points={{-80,-10},{-60,-10},{-60,
            -50},{0,-50},{0,-40}}, color={0,0,255})}));
  end DiodeModule;
  ...
  choice(redeclare package SCpackage=PowerSystems.Semiconductors.Custom "custom")));*/
    ...
    SCpackage.SCswitch_Diode switch_D1(final par=par)
      "switch + reverse diode DC_p" annotation (Placement(transformation(
          origin={0,30},
          extent={{-10,10},{10,-10}},
          rotation=270)));
    SCpackage.SCswitch_Diode switch_D2(final par=par)
      "switch + reverse diode DC_n" annotation (Placement(transformation(
          origin={0,-30},
          extent={{-10,10},{10,-10}},
          rotation=270)));
  ...
  equation
    ...
    connect(switch_D1.term_p, pn_p_n.term_p) annotation (Line(points={{
            ...
            0,255}));
    connect(AC, switch_D2.term_p) annotation (Line(points={{100,0},{
            6.12303e-016,0},{6.12303e-016,-20}}, color={0,0,255}));
    connect(switch_D2.term_n, pn_p_n.term_n) annotation (Line(points={{-6.12303e-016,
            -40},{0,-40},{0,-50},{-40,-50},{-40,-4},{-64,-4}}, color={0,0,255}));
    connect(gates, gate2demux.gates)
      annotation (Line(points={{-60,100},{-60,80}}, color={255,0,255}));
    ...
    connect(switch_D1.heat, heat) annotation (Line(points={{-10,30},{-20,30},{-20,
            80},{0,80},{0,100}}, color={176,0,0}));
    connect(switch_D2.heat, heat) annotation (Line(points={{-10,-30},{-20,-30},
            {-20,80},{0,80},{0,100}}, color={176,0,0}));
    annotation (
      defaultComponentName="switchMod1",
      Documentation(info="<html>
...
"),   Icon(coordinateSystem(
          ...
          grid={2,2}), graphics={Line(points={{30,46},{30,-48}}, color={0,0,255}),
            Line(points={{30,-34},{16,-46}}, color={255,0,255}),Line(points={{-30,
            -48},{-30,46}}, color={0,0,255}),Line(points={{-40,-14},{-20,-14}},
            color={0,0,255}),Line(points={{-40,34},{-20,34}}, color={0,0,255}),
            Line(points={{20,14},{40,14}}, color={0,0,255}),Line(points={{20,-34},
            {40,-34}}, color={0,0,255}),Line(points={{-30,0},{80,0}}, color={0,
            0,255}),Polygon(
              ...
              lineColor={0,0,255},
              fillColor={0,0,255},
              fillPattern=FillPattern.Solid),Line(points={{30,14},{16,2}},
            color={255,0,255}),Line(points={{-80,10},{-60,10},{-60,46},{30,46}},
            color={0,0,255}),Line(points={{-80,-10},{-60,-10},{-60,-48},{30,-48}},
            color={0,0,255})}));
  end SwitchModule;
